...
·
[**Hugging Face**](https://huggingface.co/andreiradu2102)
·
[**Email**](mailto:andrei.gabriel.radu@gmail.com)
...
The project included **LoRA fine-tuning, stratified cross-validation, frame caching, automated preprocessing and evaluation, zero-shot experiments, and live FastAPI inference**.

It won **1st Prize in the Distributed Systems section of UPB's Student Scientific Communications Session (SCSS)** and advanced to the competition's final stage.
...
<p align="center">
  <a href="https://skillicons.dev">
    <img
      src="https://skillicons.dev/icons?i=fastapi,flask,dotnet,postgres,redis,rabbitmq&theme=dark&perline=6"
...
<p align="center">
  <a href="https://skillicons.dev">
    <img
      src="https://skillicons.dev/icons?i=docker,kubernetes,jenkins,nginx,prometheus,grafana,linux,git,githubactions&theme=dark&perline=9"
      alt="Infrastructure and Observability"
    />
  </a>
</p>

<div align="center">
  <code>Docker · Kubernetes · CI/CD · Jenkins · NGINX · Prometheus · Grafana · Linux · Git</code>
</div>
...
<p align="center">
  <a href="https://skillicons.dev">
    <img
      src="https://skillicons.dev/icons?i=react,angular,html,css&theme=dark&perline=4"
      alt="Frontend"
    />
  </a>
</p>
...
<div align="center">
  <code>React · Angular · Ext JS · HTML/CSS</code>
</div>
...
## `> selected_work --impact`

### `01 // Misinformation Detection in Social Media Videos`
...
<summary><code>> project.index --more</code></summary>

<br>

| Project | Engineering signal |
| --- | --- |
| [`MapReduce Inverted Index`](https://github.com/andreiradu2102/Parallel-computation-of-an-inverted-index-using-the-Map-Reduce-paradigm) | Parallel data processing · C++ · MapReduce |
| [`BitTorrent Protocol`](https://github.com/andreiradu2102/-BitTorrent-Protocol) | P2P networking · protocol implementation · C++ |
| [`Memory Allocator`](https://github.com/andreiradu2102/Memory-Allocator) | Low-level memory management · C |
| [`Sokoban AI`](https://github.com/andreiradu2102/Sokoban-AI) | BFS · DFS · A* · heuristic search |
...
<div align="center">
  <img
    src="https://github-readme-activity-graph.vercel.app/graph?username=andreiradu2102&bg_color=0d1117&color=9be9a8&line=22c55e&point=ffffff&area=true&area_color=16a34a&border_color=14532d&hide_border=false&custom_title=ACTIVITY%20TRACE&radius=8"
    alt="Andrei Radu — GitHub Activity Graph"
    width="860"
  />
</div>
...
<div align="center">
  <img
    src="https://streak-stats.demolab.com?user=andreiradu2102&background=0D1117&border=14532D&stroke=14532D&ring=22C55E&fire=22C55E&currStreakNum=22C55E&sideNums=C9D1D9&currStreakLabel=C9D1D9&sideLabels=8B949E&dates=8B949E&border_radius=8"
    alt="Andrei Radu — GitHub Streak"
  />
</div>
...
[**Hugging Face**](https://huggingface.co/andreiradu2102)
·
[**GitHub**](https://github.com/andreiradu2102)
·
[**Email**](mailto:andrei.gabriel.radu@gmail.com)
